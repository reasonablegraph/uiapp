...
//  },
 ...
 'ea:relation:PersonOtherUncles': {
  ...
  'ea:relation:descriptionOfItem':{
	...
	'ea:relation:PersonOrganizationInmate':{
		reverse_relation:'ea:relation:OrganizationPersonInmate'
	},

	'ea:relation:OrganizationPersonInmate':{
		reverse_relation:'ea:relation:PersonOrganizationInmate'
	},
	...
	'ea:relation:PersonOrganizationStudent':{
	reverse_relation:'ea:relation:OrganizationPersonStudents'
	},

	'ea:relation:OrganizationPersonStudents':{
		reverse_relation:'ea:relation:PersonOrganizationStudent'
	},
  ...
  'ea:relation:OrganizationAlterAcronym_name_not':{
	...
	'ea:relation:containedInSpeecheskoko':{
		reverse_relation:'kokolala'
	},
	...
	'ea:relation:PlaceOrganizationMunicipal':{
		reverse_relation:'ea:relation:OrganizationPlaceMunicipal'
	},

	'ea:relation:OrganizationPlaceMunicipal':{
		reverse_relation:'ea:relation:PlaceOrganizationMunicipal'
	},


	'ea:relation:PlaceOrganizationMunicipal_Unity':{
		reverse_relation:'ea:relation:OrganizationPlaceMunicipal_Unity'
	},

	'ea:relation:OrganizationPlaceMunicipal_Unity':{
		reverse_relation:'ea:relation:PlaceOrganizationMunicipal_Unity'
	},

	'ea:relation:PlaceOrganizationEducational':{
		reverse_relation:'ea:relation:OrganizationPlaceEducational'
	},

	'ea:relation:OrganizationPlaceEducational':{
		reverse_relation:'ea:relation:PlaceOrganizationEducational'
	},

	'ea:relation:PlaceOrganizationCommunity':{
		reverse_relation:'ea:relation:OrganizationPlaceCommunity'
	},

	'ea:relation:OrganizationPlaceCommunity':{
		reverse_relation:'ea:relation:PlaceOrganizationCommunity'
	},

	'ea:relation:PlaceOrganizationState':{
		reverse_relation:'ea:relation:OrganizationPlaceState'
	},

	'ea:relation:OrganizationPlaceState':{
		reverse_relation:'ea:relation:PlaceOrganizationState'
	},

	'ea:relation:PlaceOrganizationAdministrative':{
		reverse_relation:'ea:relation:OrganizationPlaceAdministrative'
	},

	'ea:relation:OrganizationPlaceAdministrative':{
		reverse_relation:'ea:relation:PlaceOrganizationAdministrative'
	},

	'ea:relation:PlaceOrganizationRegional':{
		reverse_relation:'ea:relation:OrganizationPlaceRegional'
	},

	'ea:relation:OrganizationPlaceRegional':{
		reverse_relation:'ea:relation:PlaceOrganizationRegional'
	},

	'ea:relation:PlaceOrganizationUnknown':{
		reverse_relation:'ea:relation:OrganizationPlaceUnknown'
	},

	'ea:relation:OrganizationPlaceUnknown':{
		reverse_relation:'ea:relation:PlaceOrganizationUnknown'
	},

	'ea:event:musical_work':{
		reverse_relation:'ea:work:music_event'
	},

	'ea:work:music_event':{
		reverse_relation:'ea:event:musical_work'
	},

...
var personal_name_not_used_map = {
		'ea:auth:PersonNotUsedGivenName' : 'Given Name (not use)',
		'ea:auth:PersonNotUsedOfficialName' : 'Official Name (not use)',
		'ea:auth:PersonNotUsedReligionName' : 'Religion Name (not use)',
		'ea:auth:PersonNotUsedPseudonymShared' : 'Pseudonym Shared (not use)',
		'ea:auth:PersonNotUsedSecularName' : 'Secular Name (not use)',
		'ea:auth:PersonNotUsedNameBeforeMarriage' : 'Name Before Marriage (not use)',
		'ea:auth:PersonNotUsedRealName' : 'Real Name (not use)',
		'ea:auth:PersonNotUsedMarriedName' : 'Married Name (not use)',
		'ea:auth:PersonNotUsedPseudonym' : 'Pseudonym (not use)',
		'ea:auth:PersonNotUsedOther' : 'Other Name (not use)',
	};


var personal_alternative_name_map = {
		'ea:auth:PersonAlterGivenName' : 'Given Name (alternative)',
		'ea:auth:PersonAlterOfficialName' : 'Official Name (alternative)',
		'ea:auth:PersonAlterReligionName' : 'Religion Name (alternative)',
		'ea:auth:PersonAlterPseudonymShared' : 'Pseudonym Shared (alternative)',
		'ea:auth:PersonAlterSecularName' : 'Secular Name (alternative)',
		'ea:auth:PersonAlterNameBeforeMarriage' : 'Name Before Marriag (alternative)',
		'ea:auth:PersonAlterRealName' : 'Real Name (alternative)',
		'ea:auth:PersonAlterMarriedName' : 'Married Name (alternative)',
		'ea:auth:PersonAlterPseudonym' : 'Pseudonym (alternative)',
		'ea:auth:PersonAlterOtherName' : 'Other Name (alternative)',
	};

...
var digital_item_relation_base = {
		...
		'skip_title_for_new_object': true, //####if enable then skip 'primary' field title, non-obligatory
		'hide_title_for_new_object': true, //####if disable then display value-label = parent-key 1st way
		//'tmp_title_for_new_object': key_labels['new physical-item'],  //####if disable then tmp value-label = key_labels['tmp_title_for_new_object_'+object_type] 2nd way
		...
		'object_type' : {
			'physical-item' : {
				...
				'new_button_label' : key_labels['new physical-item'],
				'extend_commands' : f_physical_item_extend,
			},
			'digital-item' : {
				'extend_primary_key' : 'dc:title:',
				'extend_primary_label' : key_labels['ea:item:title'],
				'new_button_label' : key_labels['new digital-item'],
...
//					'object_type':'digital-item',
					...
					'label':key_labels['ea:manif:item'],
...
{{#ea:manif:Publication_Date}} {{{v}}} {{/ea:manif:Publication_Date}}',
	...
	cmdCreate('manif_publication_extend',{
	    ...
	    opts:{
	      ...
	      commands:['manif_publication','manif_publication_place','manif_publication_name','manif_publication_date'/*,'url_public'*/], //SOVARIKO
	    }
});

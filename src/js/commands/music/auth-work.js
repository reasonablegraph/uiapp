...
cmdCreate('header_public_work_music',{
	action:'addSection',
	opts : jQuery.extend({},commands.header_type.opts,{
		label:key_labels['ea:work:Header_Music'],
		class:'sect_work_level_1',
	})
});
...
/*******************  Work Type ********************/
/***************************************************/
var changeManifType = function(e){
	fc.setupForm(formSetups[jQuery(this).val()]);
};

cmdCreate('work_entity_type',{
		action : 'setupField',
		opts : jQuery.extend({},opts_text,{
			'key' : 'ea:form-type:',
			'label':key_labels['ea:control:Entity_Type'],
			type : 'select',
			select_values:type_work_entity_map,
			//default_selection : 'auth-manifestation-book' || 'auth-manifestation-issue',
			on_select:changeManifType,
			width:120,
			float:'left',
		})
	});

//cmdCreate('manif_type_book_hidden',{
//	action:'setupField',
//	opts : jQuery.extend({},commands.manif_type.opts,{
//		type : 'hidden',
//		key : 'ea:form-type:',
//		value: 'book',
//	})
//});
//
//cmdCreate('manif_type_periodic_hidden',{
//	action:'setupField',
//	opts : jQuery.extend({},commands.manif_type.opts,{
//		type : 'hidden',
//		key : 'ea:form-type:',
...
cmdCreate('work_form_music',{
	action : 'setupField',
	opts : jQuery.extend({},commands.work_form.opts,{
		label:key_labels['ea:work:Form_Music'],
		key : 'ea:work:Form_music',
...
/**********************************************/
cmdCreate.relation({
	'cmd_name':'work_music_event',
	'object_type':'auth-event',
	'key' : 'ea:work:music_event',
	'label':key_labels['ea:work:music_event'],
...
cmdCreate('work_typology_music',{
	action : 'setupField',
	opts : jQuery.extend({},commands.work_typology.opts,{
		label:key_labels['ea:work:TypologyWork_Music'],
		key : 'ea:work:TypologyWork_music',
	})
});
...
cmdCreate('header_work_manifestation_music_sect',{
  action: "addSectionExt",
	opts : jQuery.extend({},commands.header_work_manifestation_sect.opts,{
		"command": 'manifestation_music_work_extend',
	})
});
...
cmdCreate('manifestation_music_work_extend',{
	"action": "extend",
	opts : jQuery.extend({},commands.manifestation_work_extend.opts,{
		"commands": f_auth_manifestation_music_work
	})
});

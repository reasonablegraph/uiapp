...
cmdCreate('header_expression_public_music',{
	action:'addSection',
	opts : jQuery.extend({},commands.header_expression_public.opts,{
		label:key_labels['expression_header_public_music'],
		class:'sect_expres_level_1',
	})
});
...
cmdCreate('express_music_type_hidden',{
	action : 'setupField',
	opts : jQuery.extend({},opts_text,{
		'key' : 'ea:form-type:',
		type : 'hidden',
		value: 'auth-expression-music',
	})
});

cmdCreate('express_type_hidden',{
	action : 'setupField',
	opts : jQuery.extend({},opts_text,{
		'key' : 'ea:form-type:',
		type : 'hidden',
...
cmdCreate('expres_form_music',{
	action : 'setupField',
	opts : jQuery.extend({},commands.expres_form.opts,{
		label:key_labels['ea:expres:Form'],
		key : 'ea:expres:Form_music',

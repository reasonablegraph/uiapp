...
cmdCreate('header_manifestation_music_public',{
	action:'addSection',
	opts : jQuery.extend({},commands.header_manifestation_public.opts,{
		label:key_labels['Header_Manifestation_Music'],
	})
});
...
cmdCreate('manif_music_type_hidden',{
	action:'setupField',
	opts : jQuery.extend({},opts_text,{
		type : 'hidden',
		key : 'ea:form-type:',
		value: 'auth-manifestation-music',
	})
});

...
cmdCreate('header_work_music_expression_sect',{
	action : 'addSectionExt',
	opts : jQuery.extend({},commands.header_work_expression_sect.opts,{
		"command": 'expression_music_work_extend',
	})
});
...
cmdCreate('expression_music_work_extend',{
  "action": "extend",
	opts : jQuery.extend({},commands.expression_work_extend.opts,{
		 "commands": f_auth_expression_music_work
	})
});

...
cmdCreate.relation(jQuery.extend({},contributor_relation_base ,{
  ...
  'key' : 'ea:manif:Publisher_Name',//'ea:manif:Distribution_Name',
...
cmdCreate.relation(jQuery.extend({},contributor_relation_base ,{
  ...
  'key' : 'ea:manif:Publisher_Name',//'ea:manif:Manufactur_Name',
...
cmdCreate.relation(jQuery.extend({},contributor_relation_base ,{
  ...
  'key' : 'ea:manif:Publisher_Name',//'ea:manif:Production_Name',

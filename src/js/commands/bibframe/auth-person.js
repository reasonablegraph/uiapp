...
cmdCreate('personal_name_in_other_lang',{
    action : 'setupField',
    opts : jQuery.extend({},opts_multy_text,{
      'key' : 'ea:auth:person_name_other_lang',
      'label':key_labels['ea:auth:person_name_other_lang'],
			'repeat_style' : 'ordered',
      'lang_select':{
...
cmdCreate('personal_name_not_used',{
  action : 'setupField',
  opts : jQuery.extend({},opts_multy_text,{
//    'key' : 'ea:auth:Person_Name_Not_Used',
  	'key':personal_name_not_used_map,
		'select_key_width':'96px',
		'width':550,
...
cmdCreate('personal_alternative_name',{
	action : 'setupField',
	opts : jQuery.extend({},opts_multy_text,{
//    'key' : 'ea:auth:Person_Alternative_Name',
		'key':personal_alternative_name_map,
		'select_key_width':'96px',
		'width':550,

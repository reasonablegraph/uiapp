...
//header relator public
cmdCreate('header_relator_public',{
	action:'addSection',
	opts : jQuery.extend({},commands.header_type.opts,{
		id:'sect_genre_public',
		skey:'sect_genre_public',
		label:key_labels['relator_header_public'],
		class:'sect_genre_level_1',
		level:1,
	})
});

//extented header relator public
cmdCreate('header_relator_public_extented',{
	action:'addSection',
	opts : jQuery.extend({},commands.header_genre_public.opts,{
		label:key_labels['relator_header_public'],
		skey:'sect_genre_public_extented',
...
//authoritative label
cmdCreate('authoritative_label',{
  action : 'setupField',
  opts : jQuery.extend({},opts_text,{
    'key' : 'bf:authoritativeLabel:',
    'label':key_labels['authoritative_label'],
    'lang_select':{
    	default_lang:language_default,//language_default_inherited,
...
//rdfs:label
cmdCreate('relator_label',{
  action : 'setupField',
  opts : jQuery.extend({},opts_text,{
    'key' : 'bf:relatorLabel:',
    'label':key_labels['relator_label'],
    'lang_select':{
    	default_lang:language_default,//language_default_inherited,
			available_languages: languages_avail,
			dist_right: false,
...
//skos:prefLabel
cmdCreate('relator_pref_label',{
  action : 'setupField',
  opts : jQuery.extend({},opts_text,{
    'key' : 'bf:relatorPrefLabel:',
    'label':key_labels['relator_pref_label'],
    'lang_select':{
			default_lang:language_default,//language_default_inherited,
			available_languages: languages_avail,
			dist_right: false,
...
//code
cmdCreate('relator_code',{
  action : 'setupField',
  opts : jQuery.extend({},opts_text,{
    'key' : 'bf:relatorCode:',
    'label':key_labels['relator_code'],
  })
});
